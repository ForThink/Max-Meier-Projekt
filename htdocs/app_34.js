...
const tabcontent = (ranking)=>{
    ...
    if(ranking.length<10){
        ...
        ${!top5.includes(uid)&&!last5.includes(uid)?'<table style="border: 1px solid black; border-collapse: collapse"><tr><td style="width: 20px;">'+(ranking.indexOf(uid)+6)+'</td><td style="width: 120px">DU</td></tr></table>':""}
