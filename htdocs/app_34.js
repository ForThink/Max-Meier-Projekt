...
const tabcontent = (ranking)=>{
    ...
    if(ranking.length<10){
        ...
        ${!top5.includes(uid)&&!last5.includes(uid)?'<tr style=\"background-color: grey\" ><td style="width: 20px;">'+(ranking.indexOf(uid)+6)+'</td><td style="width: 120px">DU</td></tr>':"<tr style=\"background-color: grey\" ><td style=\"width: 140px\"></td></tr>"}
