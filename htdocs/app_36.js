...
<svg width="${window.innerWidth>500?200:window.innerWidth*0.4}" height ="${window.innerWidth>500?200:window.innerWidth*0.4}">
    ...
    <text y="${window.innerWidth>500?194:window.innerWidth*0.4-window.innerWidth/50+window.innerWidth/125}" x="${window.innerWidth>500?175/4:(window.innerWidth*0.4-25)/4}" style="fill:black;font-size: ${window.innerWidth>500?15:3*window.innerWidth/100}px;" >${numtoday(trdag[1])}</text>
    <text y="${window.innerWidth>500?194:window.innerWidth*0.4-window.innerWidth/50+window.innerWidth/125}" x="${window.innerWidth>500?175/2:(window.innerWidth*0.4-25)/2}" style="fill:black;font-size: ${window.innerWidth>500?15:3*window.innerWidth/100}px;" >${numtoday(twdag[1])}</text>
    <text y="${window.innerWidth>500?194:window.innerWidth*0.4-window.innerWidth/50+window.innerWidth/125}" x="${window.innerWidth>500?3*175/4:3*(window.innerWidth*0.4-25)/4}" style="fill:black;font-size: ${window.innerWidth>500?15:3*window.innerWidth/100}px;" >${numtoday(yesterday[1])}</text>
    <text y="${window.innerWidth>500?194:window.innerWidth*0.4-window.innerWidth/50+window.innerWidth/125}" x="${window.innerWidth>500?175:(window.innerWidth*0.4-25)}" style="fill:black;font-size: ${window.innerWidth>500?15:3*window.innerWidth/100}px;" >${numtoday(today[1])}</text>
    <line x1="${window.innerWidth>500?25:window.innerWidth/20}" x2="${window.innerWidth>500?175/4:(window.innerWidth*0.4-25)/4}" y1="${window.innerWidth>500?175:(window.innerWidth*0.4-25)}" y2="${window.innerWidth>500?175-175*trdag[0]/((total-sock)>0?(total-sock):1):(window.innerWidth*0.4-window.innerWidth/20)-(window.innerWidth*0.4-window.innerWidth/20)*trdag[0]/((total-sock)>0?(total-sock):1)}"/>
    <line x1="${window.innerWidth>500?175/4:(window.innerWidth*0.4-25)/4}" x2="${window.innerWidth>500?175/2:(window.innerWidth*0.4-25)/2}" y1="${window.innerWidth>500?175-175*trdag[0]/((total-sock)>0?(total-sock):1):window.innerWidth*0.4-window.innerWidth/20*trdag[0]/((total-sock)>0?(total-sock):1)}" y2="${window.innerWidth>500?175-175*twdag[0]/((total-sock)>0?(total-sock):1):window.innerWidth*0.4-window.innerWidth/20-(window.innerWidth*0.4-window.innerWidth/20)*twdag[0]/((total-sock)>0?(total-sock):1)}"/>
    <line x1="${window.innerWidth>500?175/2:(window.innerWidth*0.4-25)/2}" x2="${window.innerWidth>500?3*175/3:3*(window.innerWidth*0.4-25)/4}" y1="${window.innerWidth>500?175-175*twdag[0]/((total-sock)>0?(total-sock):1):window.innerWidth*0.4-window.innerWidth/20*twdag[0]/((total-sock)>0?(total-sock):1)}" y2="${window.innerWidth>500?175-175*yesterday[0]/((total-sock)>0?(total-sock):1):window.innerWidth*0.4-window.innerWidth/20-(window.innerWidth*0.4-window.innerWidth/20)*yesterday[0]/((total-sock)>0?(total-sock):1)}"/>
    <line x1="${window.innerWidth>500?3*175/3:3*(window.innerWidth*0.4-25)/4}" x2="${window.innerWidth>500?175:(window.innerWidth*0.4-25)}" y1="${window.innerWidth>500?175-175*yesterday[0]/((total-sock)>0?(total-sock):1):window.innerWidth*0.4-window.innerWidth/20*yesterday[0]/((total-sock)>0?(total-sock):1)}" y2="${window.innerWidth>500?175-175*today[0]/((total-sock)>0?(total-sock):1):window.innerWidth*0.4-window.innerWidth/20-(window.innerWidth*0.4-window.innerWidth/20)*today[0]/((total-sock)>0?(total-sock):1)}"/>
    </svg>`
